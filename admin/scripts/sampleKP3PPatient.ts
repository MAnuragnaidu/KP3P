...
export function sampleKP3PPatient(): PatientData {
  ...
  return {
    ...
    colonoscopyFindings: 'Moderate ileocolonic inflammation',
    imagingFindings: 'Terminal ileum thickening',
    recentImaging: 'Terminal ileum thickening',
    dexa: 'Not done',
    mostRecentDexaScan: 'Not done',
    ...
    previousTreatmentsTried: 'Azathioprine / 6-Mercaptopurine, Infliximab (Remicade / Infimab / Inflixirel)',
    steroidUse: 'Recently stopped (less than 3 months ago)',
    currentSupplements: 'Vitamin D 1000 IU daily',
    tbStatus: 'Negative',
    hbsAg: 'Negative',
